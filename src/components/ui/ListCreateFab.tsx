...
export const ListCreateFab: React.FC<ListCreateFabProps> = ({
  ...
  <button
    ...
    aria-label={title}
    onClick={onClick}
    className={`absolute bottom-18 right-3 z-30 flex h-11 w-11 items-center justify-center rounded-full bg-orange-500 text-white shadow-lg hover:bg-orange-600 transition-colors ${className}`}
  >
