...
export const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <div className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-3 sm:px-4 gap-2 sm:gap-4">
      {/* Mobile-only menu toggle (branding lives in the sidebar) */}
      <button
        onClick={onMenuClick}
      ...
      <div className="flex-1 max-w-xl">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm bg-gray-100 border border-transparent rounded-full focus:outline-none focus:border-blue-600 focus:bg-gray-100"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
        ...
        <div className="relative" ref={createRef}>
          <button
            ...
            className="w-8 h-8 bg-orange-500 hover:bg-orange-600 rounded-full flex items-center justify-center transition-colors shadow-sm"
            title="Create new"
          >
        ...
        {/* Timer pill */}
        <div className="hidden sm:flex items-center gap-2 pl-2 pr-3 py-1 bg-gray-100 rounded-full">
          <button
            onClick={() => setIsTimerRunning((r) => !r)}
            className="w-6 h-6 flex items-center justify-center rounded-full bg-white hover:bg-gray-50 transition-colors"
          ...
          <span className="text-sm font-mono text-gray-700">00:00:00</span>
        </div>
